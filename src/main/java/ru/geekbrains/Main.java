...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       // product3.price = -50.5;
        ...
        //Product Chocolate1 = new Chocolate()
        Chocolate Chocolate1 = new Chocolate("Alpen Gold", 150,220);
      ...
      ;
       ...
       // }
        ...
        products1.add(Chocolate1);

        ChocolateVendingMachine machine1 = new ChocolateVendingMachine(products1);
        Chocolate chocolateRes = machine1.getChocolate("Alpen Gold", 220);
        if(chocolateRes !=null) {
            System.out.println("Вы купили шоколад: ");
            System.out.println(chocolateRes.displayInfo());
        }
        else{
                System.out.println("Такой шоколадки нету");
